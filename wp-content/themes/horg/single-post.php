...
while (have_posts()) :
	...
	<main id="conteudo">
		...
		<?php if (has_post_thumbnail()) : ?>
			<?php the_post_thumbnail('aw-hero', array('class' => 'hero-img max-h-130', 'alt' => get_the_title(), 'loading' => 'eager', 'fetchpriority' => 'high')); ?>
		<?php else : ?>
			<div class="aw-placeholder hero-img max-h-130">[ <?php esc_html_e('imagem destacada do artigo', 'alfama-web'); ?> ]</div>
		<?php endif; ?>
